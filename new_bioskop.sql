...
INSERT INTO `film` (`kd_film`, `gambar`, `judul`, `sinopsis`, `kategori`, `tgl`, `jam`, `kd_studio`, `nama_studio`) VALUES
(1, 0x32626666372d626c61646572756e6e65722e6a7067, 'rina', '<p>\r\n	helpful</p>\r\n', 'Thriler', '2017-11-08', '13.00-15.30', 101101, '101101'),
(123, '', 'annabell', '0000-00-00', 'Horor', '2017-11-07', '11.00-13.30', 101101, '101101'),
(124, '', 'Annabelle', '0000-00-00', '', '2017-11-01', '', 1, 'starplex');
...
INSERT INTO `informasi` (`nim`, `nama`, `kelas`) VALUES
(10115633, 'M Ridwan F', 'IF14');
...
--
ALTER TABLE `film`
  MODIFY `kd_film` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=125;
--
